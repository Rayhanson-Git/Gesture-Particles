...
import {
  Globe, CircleDot, Sparkles, Dna, Star, Circle, Waves,
...
export const EnhancedControlPanel = ({
  ...
  if (isCollapsed) {
    return (
      <button
        ...
        className="fixed top-6 left-6 bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl p-4 shadow-2xl hover:bg-black/40 transition-all"
      >
  ...
  return (
    <div className="fixed top-6 left-6 bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl w-80 max-h-[90vh] overflow-y-auto">
