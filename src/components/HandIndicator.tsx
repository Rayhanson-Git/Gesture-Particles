...
export const HandIndicator = ({ leftHand, rightHand }: HandIndicatorProps) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 bg-black/30 backdrop-blur-md border border-white/10 rounded-2xl p-5 shadow-2xl w-72">
      ...
      <div className="mt-5 pt-4 border-t border-white/10">
        <p className="text-xs text-white/50 leading-relaxed">
          Spread thumb and pointer finger on your right hand to scale particles. Rotate your left wrist to spin them.
        </p>
      </div>
    </div>
  );
